...
**Permissioned bubbles** (optional) can be applied to segment specific user interactions or environments, may support segmented user environments or feature gating where needed.
...
- **Leverage Long**: For users who want to amplify their exposure to price appreciation in specific assets, this strategy borrows additional assets to take long positions, potentially magnifying gains and losses in directional markets.
