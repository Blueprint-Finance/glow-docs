...
2. **SOL Balance Requirement**: You must have at least **0.072 SOL** in your wallet to cover the <del class="review-diff">rent fees for both required transactions — one for creating the margin account and another for completing the final account setup. This fee is used for Solana blockchain storage. In a later release, we will allow users to close their margin accounts and receive a full refund of this rent fee.</del><ins class="review-diff">one-time, refundable rent fee required by Solana for on-chain storage. You can close a margin account from the Portfolio page and receive the full rent fee back to your wallet.</ins>
3. **Multiple Accounts = Additional Rent Fees**: Each additional margin account requires an additional rent fee. <del class="review-diff">In a future release, users will have the option to close a margin account and receive the full rent fee refunded back to their wallets.</del>
...
## Step 3: <del class="review-diff">Pay the Rent Fee</del><ins class="review-diff">Create Your Margin Account</ins>

In the **New Margin Account** modal:

- You'll see <ins class="review-diff">the account name (e.g. "Account #1") and</ins> a **one-time rent** of **0.072 SOL**.
- The modal explains that this rent fee is required by Solana and <del class="review-diff">will be fully refundable upon account closure.</del><ins class="review-diff">is fully refundable when you close the account.</ins>
- Click **Create Margin Account** to proceed. <ins class="review-diff">Glow will handle the full setup automatically — you'll need to approve two quick wallet transactions in sequence.</ins>
...
<div class="review-removed-section">

**Removed: Step 5 (Complete Margin Account Setup)** — <del class="review-diff">The separate "Create Lookup Table" step has been removed entirely. Lookup table creation is now handled automatically as part of Step 3.</del>

</div>

## Step <del class="review-diff">6</del><ins class="review-diff">4</ins>: Confirmation

<del class="review-diff">Once both steps are complete—rent fee payment and the final account setup transaction—you'll</del><ins class="review-diff">Once setup is complete, you'll</ins> receive a notification that your new margin account has been successfully created.
...
## Step <del class="review-diff">7</del><ins class="review-diff">5</ins>: Review Your Margin Account Panel
...
## Finish Account Setup (Existing Accounts) <ins class="review-diff">(NEW SECTION)</ins>
